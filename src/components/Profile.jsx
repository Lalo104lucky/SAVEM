        ...
        >
          ...
          <div className="bg-white rounded-r-lg shadow-lg max-w-lg w-full relative p-4 dark:bg-gray-900">
            ...
            <div className="space-y-2 ">
              <h2 className="text-2xl font-bold font-quicksand custom-blue custom-blueDark">Perfil Administrador</h2>
              <p className="text-lg text-gray-800 font-semibold font-quicksand dark:text-gray-300">Ana María Sánchez López</p>
              <p className="text-base text-gray-600 font-quicksand dark:text-gray-300">ana.sanchez@empresa.com</p>
              <p className="text-base text-gray-600 font-quicksand dark:text-gray-300">RFC: SALA850612M45</p>
