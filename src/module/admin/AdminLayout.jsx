...
const AdminLayout = () => {
  ...
  return (
    ...
    <div className="flex">
      <aside className="fixed h-screen text-base top-0 left-0 z-40 flex-1 transition-transform bg-custom-blue dark:bg-gray-800 w-52">
        <div className="h-full overflow-y-auto bg-custom-blue dark:bg-blue-800">
          ...
          <ul className="space-y-2">
            <li className="w-full items-center px-3 mb-10">
              <NavLink
                to="/profile"
                className={({ isActive }) =>
                  isActive
                    ? "flex nav-a items-center p-2 text-white underline rounded-lg dark:text-white dark:bg-gray-700 group justify-center"
                    : "flex nav-a items-center p-2 text-white rounded-lg dark:text-white hover:underline hover:underline-offset-3 dark:hover:bg-gray-700 group justify-center"
                }
              >
      ...
      <main style={{ flexGrow: 1, paddingTop: '2.5rem', marginLeft: '13rem', paddingLeft: '4rem', paddingRight: '4rem' }} className='dark:bg-gray-900' >
        <section>
          <Outlet />
        </section>
      </main>
