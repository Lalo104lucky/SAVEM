        ...
        <div className='flex flex-col w-full'>
          ...
          <div className='flex justify-center w-full mt-5'>
            ...
            <label className="inline-flex items-center cursor-pointer">
              ...
              />
              <div style={{ width: '6.5rem' }} className="relative h-7 bg-gray-200 peer-focus:outline-none dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600"></div>
              <img
